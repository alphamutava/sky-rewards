      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">Create Creator Account</CardTitle>
            <CardDescription>Start earning from your content</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="email">Email <span className="text-gray-400 text-xs">(optional)</span></Label>
              ...
              <Button type="submit" className="w-full bg-[#E63946] hover:bg-red-600" size="lg" disabled={loading}>
