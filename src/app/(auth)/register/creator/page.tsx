    ...
    <div className="min-h-screen flex items-center justify-center bg-bg px-4 font-sans animate-fade">
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-3xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-display mb-2 text-white">Create Creator Account</h1>
            <p className="text-muted text-sm font-medium">Start earning from your content</p>
          </div>
